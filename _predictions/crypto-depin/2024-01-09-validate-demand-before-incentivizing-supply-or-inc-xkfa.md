...
context: |
  Explaining why Akash stayed "pre-incentive" until GPU demand was proven (A100 utilization 95%+); cites Filecoin GPUs being repurposed onto Akash as the cautionary example.
---
