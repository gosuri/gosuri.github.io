...
permalink: /powerful-twitter-api-wrapper-in-less-than-50
---

h1. {{ page.title }}

p(meta). 15 Jun 2010 - San Francisco
...
Example: The REST method 'user/show' at http://api.twitter.com/1/users/lookup.json can be invoked simply by calling Twitter.new("user","pass").user.show(:screen_name => "gregosuri")
...
#
# Copyright:: 2010, Greg Osuri. All Rights Reserved
#
...
# For Example,users/show REST method can be invoked simply by calling user.show(:user_id=>1401881)
# Usage Example:
...
class Twitter
  ...
  class TwitterResponse
    ...
    def self.construct(res)
      return res.class == Array ? res.collect { |item| TwitterResponse.new(item) } : TwitterResponse.new(res)
    end
  end
end
