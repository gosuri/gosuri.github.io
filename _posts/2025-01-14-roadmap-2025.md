...
date: "2025-01-14"
author: "Greg Osuri"
original_url: "https://akash.network/blog/roadmap-2025/"
original_publisher: "Akash Network"
canonical_url: "https://akash.network/blog/roadmap-2025/"
...
**Sovereign AI Agents**: Akash is the only general-purpose decentralized network that allows AI Agents to operate with sovereignty at scale. With [confidentiality](https://akash.network/roadmap/aep-12/) coming this year, Akash is well-positioned to be the premier decentralized hosting network for AI agents.
...
**On-chain Provider Incentives**: In 2024, we observed that demand increased fairly linearly as supply increased in the several provider [incentive pilots](https://akash.network/roadmap/aep-26/) we executed. In 2025, we bring [incentives on-chain](https://akash.network/roadmap/aep-53/) to unlock network effects-driven supply growth.

**Sovereign Services**: The [Managed Service Market (MSM)](https://akash.network/roadmap/aep-11/) strengthens the Akash ecosystem by unlocking a new wave of service providers and strengthens AKT. Services enable creators of software to generate meaningful income while sustaining and improving their work and keeping software open. Today, the value capture is at a massive imbalance where Cloud Service Providers (CSPs) are the biggest benefactors. MSM balances this asymmetry.
...
**Akash at Home**: We believe personal AI will run on home servers for privacy and security. [Akash at Home](https://akash.network/roadmap/aep-60/) aims to use spare computing power in homes to host AI workloads and bring Akash to home users.
